...
public class GrafoPesado {
    ...
    public GrafoPesado(int nroVerticeInicial)throws ExcepcionNroDeVerticesInvalidos{
        
            if(nroVerticeInicial<0){
                throw new ExcepcionNroDeVerticesInvalidos();
            }
    ...
    public void elimnarArista(int posicionOrigen,int posicionDestino)throws AristaYaExisteExcepcion{
            this.validarVertice(posicionOrigen);
            this.validarVertice(posicionDestino);
    ...
    public double peso(int verticeOrigen,int verticeDestino) throws AristaYaExisteExcepcion{
